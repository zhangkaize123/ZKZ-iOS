...
<tr><td>新闻</td><td align="right"><a href="add.php?fl=1">添加新闻</a></td></tr>
</table>
    <hr>
    <table border="1" align="center" width="70%">
        <tr><td align="center"><a href="index.php">新闻</a></td>
            <td align="center"><a href="guonei.php">国内</a></td><td align="center"><a href="guoji.php">国际</a></td>
...
mysql_query($sql);
//查询数据
$sql="select * from t_news where flid=1";//sql
...
if($recordcount>0)//如果有返回行
{
    ...
    while($row=mysql_fetch_assoc($rs))//得到一行
    {
        ...
        echo "</td>";
        echo "<td colspan='4'><b><a href='show.php?id=".$row['id']."'>";
        echo $row['title'];
        echo "</a></b>";
        echo "<br>";
        echo $row['subtitle'];
