...
//发送消息
-(void)sendMessage:(NSString *)__message
{
    //生成<body>文档
    ...
    //发送给谁
    [mes addAttributeWithName:@"to" stringValue:[NSString stringWithFormat:@"%@@zhouqing",@"zhq1"]];
    //由谁发送
    [mes addAttributeWithName:@"from" stringValue:[NSString stringWithFormat:@"%@@zhouqing",@"zhq"]];
    //组合
    [mes addChild:body];
    NSLog(@"%@",mes);
    //发送消息
